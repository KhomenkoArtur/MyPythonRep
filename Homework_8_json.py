...
##########  Working with JSON file and string 20240418###############
            elif choice == "6":
...
if __name__ == "__main__":
    Main = main()
    Main.run()
# JSON homework. Added class JsonFileParser and two function inside : ParseJsonFile and ParseJsonString. Also newly added logic starts from line 216 "elif choice == "6":"
...
#{"type": "privat_ad", "text": "blablabal", "expiration": "2024-05-15"}
#{"type": "news", "text": "I would like to sell a HOUSE. PRICE 144000 $", "city": "Lviv"}
#{"type": "privat_ad", "text": "I would like drink BEER.", "expiration": "2024-05-18"}
